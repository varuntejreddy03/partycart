      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 mb-16">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <p className="text-base leading-relaxed text-muted-custom max-w-sm">
              <span className="text-content font-bold">PartyCart by Yumzy.</span> <br />
              Hyderabad’s premium party food provider. <br />
              You host the party. We’ll handle the food. 🍽️✨
            </p>

            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/partycart_yumzy" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-surface border border-border-custom hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 hover:text-white flex items-center justify-center text-content transition-all duration-300 transform hover:-translate-y-1">
              ...
              <a href="https://www.linkedin.com/company/yumzy-app/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-surface border border-border-custom hover:bg-[#0077b5] hover:text-white flex items-center justify-center text-content transition-all duration-300 transform hover:-translate-y-1">
                <span className="sr-only">LinkedIn</span>
                <span className="material-icons-round text-lg">work</span>
              </a>
              <a href="https://www.facebook.com/yumzyapp" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-surface border border-border-custom hover:bg-[#1877F2] hover:text-white flex items-center justify-center text-content transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div className="border-t border-border-custom pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-[12px] font-medium text-[#6B7280]">
          ...
          <div className="flex gap-6">
            ...
            <a href="#" className="hover:text-content transition">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
