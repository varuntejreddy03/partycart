      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link to={AppRoutes.HOUSE_PARTIES} className="text-sm font-bold text-gray-300 hover:text-white transition">House Parties</Link>
            <Link to={AppRoutes.CORPORATE} className="text-sm font-bold text-gray-300 hover:text-white transition">Corporate</Link>
            <Link to={AppRoutes.BULK} className="text-sm font-bold text-gray-300 hover:text-white transition">Bulk Orders</Link>
