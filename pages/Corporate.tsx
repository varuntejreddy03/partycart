        ...
        <div className="bg-theme min-h-screen">
            ...
            <section className="relative pt-28 pb-16 z-10">
                <div className="max-w-7xl mx-auto px-5">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-surface border border-border-custom text-yellow-600 text-[10px] font-black uppercase tracking-[0.2em] mb-6">
                        <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse"></span>
                        First-In-Class Hot Boxes
                    </div>
                    <h1 className="text-6xl font-black italic text-content leading-[0.85] tracking-tight mb-8">
                        <span className="text-saffron">CATERING</span><br />
                        UP TO 100<br />
                        <span className="text-stroke text-content/50">GUESTS</span>
                    </h1>
                    <p className="text-muted-custom text-sm leading-relaxed border-l-2 border-primary pl-4 max-w-[85%] mb-10">
                        Perfect for large gatherings and events. We use temperature-controlled delivery to keep food warm for 6 hours.
                    </p>
                    <div className="flex flex-col gap-4 max-w-md">
                        <Link to={AppRoutes.QUOTE} className="w-full bg-surface border border-border-custom text-content font-black py-4 rounded-2xl flex items-center justify-center gap-3 shadow-xl transform active:scale-95 transition">
                            Explore Options <span className="material-symbols-outlined text-xl">description</span>
                        </Link>
                        <div className="grid grid-cols-2 gap-4">
                            <button className="bg-surface/80 border border-border-custom text-content py-4 rounded-2xl flex items-center justify-center gap-2 backdrop-blur-md">
            ...
            <section className="relative py-20 z-10">
                <div className="max-w-7xl mx-auto px-5">
                    <div className="mb-12">
                        <h2 className="text-4xl font-black italic text-content mb-2 uppercase">Core <span className="text-primary">Services</span></h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="group glass-card rounded-[2rem] overflow-hidden transition transform hover:-translate-y-1">
                            ...
                            <div className="p-8">
                                <h3 className="text-2xl font-bold text-content mb-3 italic">Event Catering</h3>
                                <p className="text-muted-custom text-sm mb-6">Full meal services including breakfast, lunch, or dinner. Indian banquets and multiple cuisine options available.</p>
                        ...
                        <div className="group glass-card rounded-[2rem] overflow-hidden transition transform hover:-translate-y-1">
                            ...
                            <div className="p-8">
                                <h3 className="text-2xl font-bold text-content mb-3 italic">Corporate & Large Events</h3>
                                <p className="text-muted-custom text-sm mb-6">Our temperature-controlled service ensures your food arrives hot and stays warm for 6 hours.</p>
                                <div className="flex items-center justify-between">
