        ...
        <div className="bg-theme min-h-screen">
            ...
            <section className="relative pt-32 pb-16 px-5 z-10">
                <div className="max-w-7xl mx-auto">
                    ...
                    <h1 className="text-6xl font-black italic leading-[0.85] tracking-tighter mb-4 flex flex-col uppercase text-content">
                        <span>Cozy</span>
                        <span className="text-stroke text-content/80">House</span>
                        <span className="text-yellow-500">Parties</span>
                    </h1>
                    <p className="text-muted-custom text-base max-w-[280px] leading-relaxed mb-10 border-l-2 border-emerald-500 pl-4">
                        ...
                        <div className="absolute bottom-6 left-6 right-6">
                            <div className="glass-card p-5 rounded-3xl flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xl font-black italic text-content">Home Chef Network</p>
                                </div>
                                <div className="w-12 h-12 rounded-full bg-surface flex items-center justify-center border border-border-custom">
                                    <span className="material-symbols-outlined text-content">restaurant</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="relative py-24 px-5 z-10">
                <div className="mb-12">
                    <h2 className="text-4xl font-black italic uppercase leading-none tracking-tighter mb-2 text-content">
                ...
                <div className="space-y-6 max-w-2xl">
                    <div className="glass-card rounded-[2rem] p-6 flex flex-col gap-6 relative overflow-hidden group">
                        ...
                        <div>
                            <h3 className="text-2xl font-black italic uppercase mb-2 text-content">Party Orders</h3>
                            <p className="text-muted-custom text-sm leading-relaxed mb-4">Minimum 10+ guests. Curated meals for house parties, birthdays, and get-togethers.</p>
                        </div>
                    </div>
                    ...
                    <div className="glass-card rounded-[2rem] p-6 flex flex-col gap-6 relative overflow-hidden group">
                        ...
                        <div>
                            ...
                            <p className="text-muted-custom text-sm leading-relaxed mb-4">Prasadam meals for poojas, pure-veg festive treats, and specialized menus tailored to your ceremony.</p>
                        </div>
                    </div>
                </div>
            </section>
